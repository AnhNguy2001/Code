          ...
          <div class="subnav">
           ...
           <div class="col-md-6">
            <div class="right">
              ...
              <div class="social-icons-subnav hidden-sm hidden-xs">
                <a data-toggle="modal" data-target="#fsignUp"><span class="ti-user"></span> Đăng kí</a>
              </div>
            </div>
           </div>
            ...
            <nav id="menu-center">
              <ul>
                ...
                <li>
                 ...
                 <a href="index.html">Trang chủ <i class=" fa fa-angle "></i></a>
                </li>
                <li>
                  <a href="about.html">Giới thiệu <i class="fa fa-angle "></i></a> 
                </li>

                <li>
                  <a class="actived" href="works.php">Thư viện <i class="fa fa-angle "></i></a> 
                </li>
                <li>
                  <a  href="destination.php">Điểm đến <i class="fa fa-angle "></i></a>
                </li>
                  <!-- <ul>
                ...
                <li><a href="contact.html" >Liên hệ<i class="fa fa-angle "></i></a></li>
              </ul>
            </nav>
          </div>
          <!-- mainmenu end -->
                    ...
                    <?php
                      ...
                      while ($row = mysqli_fetch_array($noi_dung)) 
                      {
                        ...
                        <div class="w-gallery <?php echo $row['loai_hinh'];?> ">
                          ...
                          <img src="<?php echo $row['anh_1'] ;?>" alt="ảnh" class="w-gallery-image"> 
                        <div class="overlay">
                  ...
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      <form>
                        ...
                        <div class="form-group">
                        <label><input type="checkbox" name="terms"> Tôi đồng ý với <a href="#">Các điều khoản và điều kiện</a>.</label>
                        </div>
                        <div class="form-group"><input type="submit" value="Đăng kí" class="btn btn-primary btn-block btn-lg"></div>
